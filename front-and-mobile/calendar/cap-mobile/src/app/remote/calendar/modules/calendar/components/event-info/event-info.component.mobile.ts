...
@Component({
    templateUrl: 'event-info.component.mobile.html',
    styleUrls: ['./styles/event-info.master.mobile.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        DestroyService,
    ],
})
export class EventInfoComponentMobile extends IModalComponent {
    /**
     * Информация о ивенте
