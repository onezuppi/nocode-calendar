...
@Component({
    ...
    templateUrl: './calendar-all-day-event-container.mobile.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./styles/calendar-all-day-event-container.master.mobile.component.scss'],
    providers: [
        DestroyService,
    ]
})
export class CalendarAllDayEventContainerMobileComponent extends AllDayContainerBaseComponent {
    @HostBinding('class')
