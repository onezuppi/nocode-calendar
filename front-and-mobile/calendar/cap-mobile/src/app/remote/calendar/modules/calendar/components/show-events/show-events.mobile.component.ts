...
@Component({
    templateUrl: 'show-events.mobile.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['styles/show-events.mobile.master.component.scss'],
})
export class ShowEventsMobileComponent extends IModalComponent {
