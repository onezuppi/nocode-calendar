...
@Component({
    templateUrl: 'create-calendar.component.mobile.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./styles/create-calendar.master.mobile.scss'],
    providers: [
        DestroyService,
    ]
})
export class CreateCalendarComponentMobile extends IModalComponent {
