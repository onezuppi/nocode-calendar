...
import { IS_READONLY_TOKEN, OneDayEventContainerBaseComponent } from '../../../../../submodule';
import dayjs from 'dayjs';

@Component({
    selector: 'app-calendar-event-container',
    templateUrl: './calendar-event-container.web.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./styles/calendar-event-container.master.web.component.scss'],
    providers: [
        DestroyService,
    ]
})
export class CalendarEventContainerWebComponent extends OneDayEventContainerBaseComponent {
    /**
