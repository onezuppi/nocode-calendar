...
@Component({
    ...
    templateUrl: 'calendar-column-title.component.web.html',
    styleUrls: ['./styles/calendar-column-title.master.web.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CalendarColumnTitleComponentWeb extends TableColumnTitleBaseComponent {
