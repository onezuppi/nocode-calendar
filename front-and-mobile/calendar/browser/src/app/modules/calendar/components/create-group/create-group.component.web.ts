...
import {
    ...
    GroupManagerBaseService, IUserGroupResponseModel,
    UserModel,
    UsersInfoCalendarRequestService,
} from '../../../../../submodule';
import { DestroyService } from '@abanking/core';
import { forkJoin, map, Observable, take, tap } from 'rxjs';
import { IEditGroupRequestModel } from '../../../../../../../common/data/request-models';

@Component({
    templateUrl: 'create-group.component.web.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./styles/create-group.master.web.scss'],
    providers: [
        DestroyService,
    ]
})
export class CreateGroupComponentWeb extends IModalComponent {
